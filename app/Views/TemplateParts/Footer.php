    ...
    <div class="container-xl">
        <div class="row text-center align-items-center flex-row-reverse">
                ...
                <ul class="list-inline list-inline-dots mb-0">
                    ...
                    <li class="list-inline-item">
                        <a href="https://github.com/sponsors/codecalm" target="_blank" class="link-secondary" rel="noopener">
                            ...
                            <i class="icon icon-inline ti ti-heart text-pink"></i>
                            Sponsor
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item">
                        Copyright &copy; <?= date('Y') ?> <a href="." class="link-secondary">Tabler</a>. All rights reserved.
                    </li>
                    <li class="list-inline-item">
                        <a href="./changelog.html" class="link-secondary" rel="noopener"> v1.4.0 </a>
                    </li>
                    <li class="list-inline-item">
                        Bu sayfa {memory_usage} MB bellek kullanılarak {elapsed_time} saniyede oluşturuldu.
                    </li>
                </ul>
            </div>
        </div>
