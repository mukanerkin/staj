...
if($CustomerStats->new_customers_compared_to_yesterday > 0){
    $daily_customer_growth_icon     = 'trending-up';
    $daily_customer_growth_color    = 'green';
}elseif($CustomerStats->new_customers_compared_to_yesterday < 0){
    $daily_customer_growth_icon     = 'trending-down';
    $daily_customer_growth_color    = 'red';
}else{
    $daily_customer_growth_icon     = 'minus';
    $daily_customer_growth_color    = 'orange';
}

$parking_lot_occupancy_percentage = ($ParkingLogStats->number_of_parked_vehicles*100) / $ParkingLotStats->capacity_of_parking_lots;

/*
Gelir artış oranı (Profit growth): Büyüme oranı (%) = ((Cari dönem geliri – önceki dönem geliri) ÷ önceki dönem geliri) × 100
    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            <div class="col-12 col-sm d-flex flex-column">
                                <h3 class="h2">Merhaba, <?= $logged_in_user->first_name ?></h3>
                                <p class="text-muted">You have 5 new messages and 2 new notifications.</p>

                                <div class="row g-5 mt-auto">
                                    <div class="col-auto">
                                        <div class="subheader">Bugünkü Müşteriler</div>

                                        <div class="d-flex align-items-baseline">
                                            <div class="h3 me-2"><?= $CustomerStats->number_of_new_customers_today ?></div>
                                            <div class="me-auto">
                                                <span class="text-<?= $daily_customer_growth_color ?> d-inline-flex align-items-center lh-1">
                                                    <?= $CustomerStats->new_customers_compared_to_yesterday ?>
                                                    <i class="icon ti ti-<?= $daily_customer_growth_icon ?> ms-1"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-auto">
                                        <div class="subheader">Gelir Artışı</div>
                                        ...
                                        <div class="d-flex align-items-baseline">
                                            ...
                                            <div class="me-auto">
                                                <span class="text-red d-inline-flex align-items-center lh-1">
                                                    -1%
                                                    <i class="icon ti ti-trending-down ms-1"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="subheader">Otopark Doluluğu</div>

                        <div class="d-flex align-items-baseline mb-2">
                            <div class="h1 mb-0 me-2"><?= "{$ParkingLogStats->number_of_parked_vehicles} / {$ParkingLotStats->capacity_of_parking_lots}" ?></div>
                            <div class="me-auto">
                                <span class="text-red d-inline-flex align-items-center lh-1">
                                    -1%
                                    <i class="icon ti ti-trending-down ms-1"></i>
                        ...
                        <div id="chart-parking-lots-occupation" class="position-relative"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Yeni Müşteriler</div>
                        ...
                        <div class="h1 mb-3">Toplam: <?= $CustomerStats->total_number_of_customers ?></div>
                        <div class="d-flex mb-2">
                            <div>Düne Göre Değişim:</div>
                            <div class="ms-auto">
                                <span class="text-<?= $daily_customer_growth_color ?> d-inline-flex align-items-center lh-1">
                                    <?= $CustomerStats->new_customers_compared_to_yesterday ?>
                                    <i class="icon ti ti-<?= $daily_customer_growth_icon ?> ms-1"></i>
                    ...
                    <div id="client-stats" class="position-relative rounded-bottom chart-sm"></div>
                </div>
            </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-facebook text-white p-3 rounded">
                                            <i class="icon ti ti-tie"></i>
                                        </span>
                                    </div>
                                    <div class="col">
                                        <div class="font-weight-medium"><?= $UserStats->total_number_of_users ?> Personel</div>
                                        <div class="text-secondary"><?php foreach($UserStats->number_of_users_according_to_user_levels as $level => $number): ?><span class="badge badge-sm"><?= $number ?> <?= ucfirst($level) ?></span><?php endforeach; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium"><?= $ParkingLotStats->number_of_parking_lots ?> Otopark</div>
                                        <div class="text-secondary"><span class="badge badge-sm">Kapasite:</span><span class="badge badge-sm"><?= $ParkingLotStats->capacity_of_parking_lots ?> Toplam</span><span class="badge badge-sm"><?= $ParkingLotStats->average_capacity_of_parking_lots ?> Ortalama</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-green text-white p-3 rounded">
                                            <i class="icon ti ti-heart-handshake"></i>
                                        </span>
                                    </div>
                                    <div class="col">
                                        <div class="font-weight-medium"><?= $CustomerStats->total_number_of_customers ?> Müşteri</div>
                                        <div class="text-secondary"><span class="badge badge-sm"><?= $CustomerStats->number_of_domestic_customers ?> Yerli</span><span class="badge badge-sm"><?= $CustomerStats->number_of_foreign_customers ?> Yabancı</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-x text-white p-3 rounded">
                                            <i class="icon ti ti-wheel"></i>
                                        </span>
                                    </div>
                                    <div class="col">
                                        <div class="font-weight-medium"><?= $VehicleStats->total_number_of_vehicles ?> Araç</div>
                                        <div class="text-secondary"><span class="badge badge-sm"><?= $VehicleStats->number_of_domestic_vehicles ?> Yerli</span><span class="badge badge-sm"><?= $VehicleStats->number_of_foreign_vehicles ?> Yabancı</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="card" style="height: 28rem">
                    <div class="card-header">
                        <h3 class="card-title">Bekleyen İş Emirleri (<?= count($pending_work_orders) ?>)</h3>
                    </div>
                    <?php if($pending_work_orders): ?>
                    <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div class="divide-y">
                            <?php foreach($pending_work_orders as $order): ?>
                            <div>
                                <div class="row">
                                    <div class="col-auto">
                                        <?php
                                        if(is_null($order->user_picture)):
                                        ?>
                                        <span class="avatar" title="<?= "{$order->user_first_name} {$order->user_last_name}" ?>"><?php $order_fullname = $order->user_first_name.' '.$order->user_last_name; $order_fullname = explode(' ', $order_fullname); foreach($order_fullname as $name) echo $name[0]; ?></span>
                                        <?php else: ?>
                                        <span class="avatar" title="<?= "{$order->user_first_name} {$order->user_last_name}" ?>" style="background-image: url(/uploads/staff/profile_pictures/<?= $order->user_picture ?>.webp)"> </span>
                                        <?php endif;?>
                                    </div>

                                    <div class="col">
                                        <span class="text-secondary"><?= Time::parse($order->created_at)->humanize(); ?></span>
                                        <div class="text-truncate">
                                            <div class="d-block text-secondary text-truncate">
                                                <strong><?= $order->vehicle_plate ?> (<?= "{$order->vehicle_brand} {$order->vehicle_model}" ?>)</strong> aracı <strong><?= $order->parking_lot ?></strong> alanı<?= $order->order_type == "park" ? "na <strong>parket</strong>." : "ndan <strong>getir</strong>."; ?>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-6">
                <div class="row row-cards">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Ülkelere Göre Müşteri ve Araç Sayıları</h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <?php
                                $percentage_of_parked_vehicles = round($ParkingLogStats->number_of_parked_vehicles*100/$VehicleStats->total_number_of_vehicles,2);
                                $percentage_of_exited_vehicles = 100-$percentage_of_parked_vehicles;
                                ?>
                                <p class="mb-3"><?= $VehicleStats->total_number_of_vehicles ?> Araçtan <strong><?= $ParkingLogStats->number_of_parked_vehicles ?> </strong>tanesi otoparkta</p>

                                <div class="progress progress-separated mb-3">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: <?= $percentage_of_parked_vehicles ?>%" aria-label="Otoparkta"></div>
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $percentage_of_exited_vehicles ?>%" aria-label="Dışarıda"></div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-auto d-flex align-items-center pe-2">
                                        ...
                                        <span>Otoparkta</span>
                                        <span class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-secondary">%<?= $percentage_of_parked_vehicles ?></span>
                                    </div>

                                    <div class="col-auto d-flex align-items-center px-2">
                                        <span class="legend me-2 bg-primary"></span>
                                        <span>Dışarıda</span>
                                        <span class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-secondary"><?= $percentage_of_exited_vehicles ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="/vendors/tabler/ui/dist/libs/apexcharts/dist/apexcharts.min.js" defer <?= csp_script_nonce() ?>></script>
<script src="/vendors/tabler/ui/dist/libs/jsvectormap/dist/jsvectormap.min.js" defer <?= csp_script_nonce() ?>></script>
<script src="/vendors/tabler/ui/dist/libs/jsvectormap/dist/maps/world.js" defer <?= csp_script_nonce() ?>></script>
<script src="/vendors/tabler/ui/dist/libs/jsvectormap/dist/maps/world-merc.js" defer <?= csp_script_nonce() ?>></script>
<?= $this->endSection() ?>
...
<script <?= csp_script_nonce() ?>>
  document.addEventListener("DOMContentLoaded", function () {
    window.ApexCharts &&
      new ApexCharts(document.getElementById("chart-parking-lots-occupation"), {
        chart: {
          type: "radialBar",
          fontFamily: "inherit",
          height: 192,
        ...
        series: [<?= round($parking_lot_occupancy_percentage,2) ?>],
        labels: [""],
        tooltip: {
          theme: "dark",
        },
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let series_client_stats = [{
        name: "Yeni Müşteri",
        data: [<?php foreach($CustomerStats->customer_creation_data as $k => $v){ echo $v.','; } ?>],
    }];
    let labels_client_stats = [<?php foreach($CustomerStats->customer_creation_data as $k => $v){echo "'{$k}',";} ?>];
    options.series=series_client_stats;
    options.labels=labels_client_stats;
    var chart_client_stats = new ApexCharts(document.getElementById("client-stats"), options);
    chart_client_stats.render();
...
<script <?= csp_script_nonce() ?>>
document.addEventListener("DOMContentLoaded", function() {
  const mapData = <?= $CountryStats->countries_map_data ?>;
  ...
  const map = new jsVectorMap({
    ...
    onRegionTooltipShow(event, tooltip, code) {
      if (mapData[code]) {
        tooltip.text(
          `${mapData[code].name}: <br>${mapData[code].customers} Müşteri\n ${mapData[code].vehicles} Araç`,
          true
        );
      }
    },
    visualizeData: {
      ...
      values: Object.fromEntries(
        Object.entries(mapData).map(([code, val]) => [code, val.total])
      )
    }
  });
});
